...
Important classes of Spark SQL and DataFrames:
    ...
    - :class:`pyspark.sql.HBaseSQLContext`
      Main entry point for accessing data stored in Apache HBase.
...
from pyspark.sql.context import SQLContext, HiveContext, HBaseSQLContext
...
__all__ = [
    'SQLContext', 'HiveContext', 'HBaseSQLContext', 'DataFrame', 'GroupedData', 'Column', 'Row',
